...
// Cross Module References
	...
	VARESTPLUGIN_API UFunction* Z_Construct_UFunction_UVaRestRequestJSON_GetResponseContentAsString();
...
// End Cross Module References
	...
	void UVaRestRequestJSON::StaticRegisterNativesUVaRestRequestJSON()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "ConstructRequest", &UVaRestRequestJSON::execConstructRequest },
			{ "ConstructRequestExt", &UVaRestRequestJSON::execConstructRequestExt },
	...
	UFunction* Z_Construct_UFunction_UVaRestRequestJSON_GetResponseContentAsString()
	{
		...
		if (!ReturnFunction)
		{
			static const UE4CodeGen_Private::FStrPropertyParams NewProp_ReturnValue = { UE4CodeGen_Private::EPropertyClass::Str, "ReturnValue", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000580, 1, nullptr, STRUCT_OFFSET(VaRestRequestJSON_eventGetResponseContentAsString_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
			auto NewProp_bCacheResponseContent_SetBit = [](void* Obj){ ((VaRestRequestJSON_eventGetResponseContentAsString_Parms*)Obj)->bCacheResponseContent = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bCacheResponseContent = { UE4CodeGen_Private::EPropertyClass::Bool, "bCacheResponseContent", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000080, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(VaRestRequestJSON_eventGetResponseContentAsString_Parms), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bCacheResponseContent_SetBit)>::SetBit, METADATA_PARAMS(nullptr, 0) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_ReturnValue,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bCacheResponseContent,
			};
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
				{ "Category", "VaRest|Response" },
...
#endif
			static const UE4CodeGen_Private::FFunctionParams FuncParams = { (UObject*(*)())Z_Construct_UClass_UVaRestRequestJSON, "GetResponseContentAsString", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x04020401, sizeof(VaRestRequestJSON_eventGetResponseContentAsString_Parms), PropPointers, ARRAY_COUNT(PropPointers), 0, 0, METADATA_PARAMS(Function_MetaDataParams, ARRAY_COUNT(Function_MetaDataParams)) };
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, FuncParams);
		}
		return ReturnFunction;
	}
	...
	UClass* Z_Construct_UClass_UVaRestRequestJSON()
	{
		...
		if (!OuterClass)
		{
			...
			static const FClassFunctionLinkInfo FuncInfo[] = {
				...
				{ &Z_Construct_UFunction_UVaRestRequestJSON_GetResponseContentAsString, "GetResponseContentAsString" }, // 325802869
...
#endif
			static const UE4CodeGen_Private::FIntPropertyParams NewProp_ResponseSize = { UE4CodeGen_Private::EPropertyClass::Int, "ResponseSize", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000020015, 1, nullptr, STRUCT_OFFSET(UVaRestRequestJSON, ResponseSize), METADATA_PARAMS(NewProp_ResponseSize_MetaData, ARRAY_COUNT(NewProp_ResponseSize_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_ResponseSize,
	...
	IMPLEMENT_CLASS(UVaRestRequestJSON, 349805307);
